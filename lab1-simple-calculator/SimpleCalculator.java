...
public class BasicCalculator {
    public static void main(String[] args) {
        ...
        System.out.println("Simple and Basic Calculator");
        System.out.println("Enter numbers or the operators only listed: (+, -, *, /, =). Type exit to quit the calculator.");
        ...
        while (true) {
            ...
            if (user_input.equals("+") || user_input.equals("-") || user_input.equals("*") || user_input.equals("/") || user_input.equals("=")) {
                ...
                System.out.println("Screen Display: " + result_displayed);
            } else {
