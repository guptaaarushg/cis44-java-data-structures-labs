...
public class SimpleSortDriver {
    public static void main(String[] args) {
        ...
        System.out.println("Before Insertion Sort: " + Arrays.toString(arr1_copy));
        SimpleSorters.insertionSort(arr1_copy, comp);
        System.out.println("After Insertion Sort:  " + Arrays.toString(arr1_copy));
        ...
        System.out.println("Before Insertion Sort: " + Arrays.toString(arr2_copy));
        SimpleSorters.insertionSort(arr2_copy, comp);
        System.out.println("After Insertion Sort:  " + Arrays.toString(arr2_copy));
        ...
        System.out.println("Before Bubble Sort:    " + Arrays.toString(arr3));
        SimpleSorters.bubbleSort(arr3, comp);
        System.out.println("After Bubble Sort:     " + Arrays.toString(arr3));

        System.out.println("Before Insertion Sort: " + Arrays.toString(arr3_copy));
        SimpleSorters.insertionSort(arr3_copy, comp);
        System.out.println("After Insertion Sort:  " + Arrays.toString(arr3_copy));
    }
}
